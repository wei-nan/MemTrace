...
CREATE INDEX IF NOT EXISTS idx_node_clusters_ws ON node_clusters(workspace_id);

ALTER TABLE memory_nodes
    ADD COLUMN IF NOT EXISTS cluster_id text REFERENCES node_clusters(id) ON DELETE SET NULL;

CREATE INDEX IF NOT EXISTS idx_memory_nodes_cluster ON memory_nodes(cluster_id);
