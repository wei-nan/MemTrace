  ...
  'zh-TW': {
    translation: {
      ...
      onboarding: {
        ...
        concept_review_title: '審核佇列',
        concept_review_desc: 'AI／MCP 的提案先進審核佇列，經人工把關才進圖譜。',
  ...
  en: {
    translation: {
      ...
      analytics: {
        ...
        tokenEfficiency: 'Full-Context Compression',
        avgTokensPerQuery: 'Avg Tokens / Query',
        fullDocTokens: 'Full Doc Tokens',
        savingsRatio: 'Full-Context Reduction Ratio',
      ...
      onboarding: {
        ...
        concept_review_title: 'Review Queue',
        concept_review_desc: 'AI/MCP proposals wait here for a human gate before entering the graph.',
