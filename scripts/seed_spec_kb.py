...
# Generated seed SQL output. This is the single canonical copy — applied
# manually per docs/DEPLOYMENT.md, not by run_migrations(). --check compares
# the regenerated SQL against exactly this.
# (The docs/schema-history/ dual-write mirror was retired 2026-07-26; see
# ws_spec_plan/mem_d880867b. Moved out of packages/api/migrations/ into its
# own seeds/ directory 2026-08-11 — it was never a migration and sharing the
# 00x_*.sql migration namespace implied otherwise; see ws_spec_plan/mem_cbac2be0.)
SQL_OUTPUT_PATHS = [
    REPO_ROOT / "packages" / "api" / "seeds" / "spec_kb.sql",  # canonical
]
